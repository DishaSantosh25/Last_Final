...
st.markdown(f"""
    <style>
        ...
        .reportview-container header {{visibility: hidden !important;}}
        
        /* Hide Streamlit Elements */
        .stApp header {{display: none !important;}}
        .css-eh5xgm {{visibility: hidden !important;}}
        .css-1avcm0n {{visibility: hidden !important;}}
        .css-14xtw13 e8zbici0 {{visibility: hidden !important;}}
        .css-1dp5vir {{visibility: hidden !important;}}
